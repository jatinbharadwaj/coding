...
A library management system is an automation system used to manage a library and its various resource management tasks, such as cataloging books, allowing checkouts and returns, invoicing, user management, etc.

For this problem, we need to design a library management system that implements some of these functionalities.
